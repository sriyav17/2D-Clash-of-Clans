...
class Healer:
    ...
    def move(self, troop):
        ...
        if(self.isInHealradius(troop.position)):
            ...
            if(troop.position[0] > self.position[0]):
                for i in range(self.speed):
                    ...
                    c = self.position[1]
                    self.position[0] += 1
                    if(self.position[0] == troop.position[0] or self.isInHealradius(troop.position)):
                        return
            else:
                for i in range(self.speed):
                    r = self.position[0] - 1
            ...
            if(troop.position[1] > self.position[1]):
                for i in range(self.speed):
                    ...
                    c = self.position[1] + 1
                    self.position[1] += 1
                    if(self.position[1] == troop.position[1] or self.isInHealradius(troop.position)):
                        return
            else:
                for i in range(self.speed):
                    r = self.position[0]
    ...
    def heal_troop(self, target):
        ...
        troops = barbarians + archers + dragons + stealth_archers + balloons
        for troop in troops:
            if(troop.alive == False):
                return

            r = abs(troop.position[0] - target.position[0])
            c = abs(troop.position[1] - target.position[1])
            if(r <= 1 and c <= 1):
...
def spawnStealthArcher(pos):
    ...
    stealth_archers.append(stealtharcher)
...
def search_for_closest_troop(pos, King):
    ...
    for troop in stealth_archers:
        if(troop.alive == False or troop.invisible == True):
            continue
